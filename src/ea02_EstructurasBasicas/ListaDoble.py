...
class Nodo:
    """Representacion de nodos de la lista doblemente enlazada
    
    Atributos
    ---------
    _item : Dato almacenado en el nodo
    _next : Referencia al siguiente nodo de la lista
    _prev : Referencia al nodo previo de la lista  
    """

    def __init__(self, item, next: 'Nodo', prev: 'Nodo'):
...
class ListaDoble:
    ...
    def split(self):
        """Divide la lista en dos mitades y retorna las dos listas"""
        # TODO : Implementar
        pass
